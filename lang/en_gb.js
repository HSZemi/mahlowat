...
\
	...
	thesis_number(number) { return "Thesis " + number; }
	get btn_make_thesis_double_weight() { return "Count double"; }
	get btn_thesis_has_double_weight() { return "Counting double"; }
	get label_your_choice() { return "Your choice"; }
	achieved_points_text(pointsForList, maxAchievablePoints) { return '' + pointsForList + '/' + maxAchievablePoints + ' Points'; }
	get default_text_no_statement() { return "<small class='text-muted'>No statement.</small>"; }
