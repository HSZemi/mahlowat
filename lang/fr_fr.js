...
\
	...
	thesis_number(number) { return "Thése " + number; }
	get btn_make_thesis_double_weight() { return "Doubler les points"; }
	get btn_thesis_has_double_weight() { return "Points doublés"; }
	get label_your_choice() { return "Votre selection"; }
	achieved_points_text(pointsForList, maxAchievablePoints) { return '' + pointsForList + '/' + maxAchievablePoints + ' Points'; }
	get default_text_no_statement() { return "<small class='text-muted'>Pas de position.</small>"; }
