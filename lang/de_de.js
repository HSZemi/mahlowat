...
\
	...
	thesis_number(number) { return "These " + number; }
	get btn_make_thesis_double_weight() { return "These doppelt gewichten"; }
	get btn_thesis_has_double_weight() { return "These wird doppelt gewichtet"; }
	get label_your_choice() { return "Deine Wahl"; }
	achieved_points_text(pointsForList, maxAchievablePoints) { return '' + pointsForList + '/' + maxAchievablePoints + ' Punkte'; }
	get default_text_no_statement() { return "<small class='text-muted'>Keine Stellungnahme.</small>"; }
